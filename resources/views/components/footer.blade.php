    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="{{route('dashboard')}}" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BlanuSeguros</span>
            </a>
        ...
        <span class="block text-sm text-gray-700 sm:text-center dark:text-gray-300">© 2023 <a href="{{route('dashboard')}}" class="hover:underline">BlanuSeguros™</a>. Todos los Derechos Reservados.</span>
    </div>
</footer>
