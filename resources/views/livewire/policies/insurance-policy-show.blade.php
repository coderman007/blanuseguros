            ...
            <div class="px-5 pb-5">
                <div class="mx-6">
                    ...
                    <div class="text-lg text-start">
                        ...
                        <p><strong>Tomador de Póliza:</strong> {{ $policy->policyHolder->first_name }} {{ $policy->policyHolder->last_name }}</p>
                        {{-- <p><strong>Beneficiario Oneroso:</strong> {{ $policy->beneficiary->name }}</p> --}}
                        <!-- Agrega más campos según tus relaciones y modelos -->
                    </div>
                </div>
            </div>
        </x-slot>
