<div class="relative p-4 bg-gray-100 rounded-lg">
    ...
    {{-- <div class="grid grid-cols-2 gap-4 md:block">
        <!-- Filtrar por la compañía de la póliza -->
        <select wire:model="brandFilter" class="md:w-32 p-2 mr-4 dark:bg-gray-800 dark:text-gray-100 text-blue-500 bg-white border-none rounded-lg shadow-lg cursor-pointer hover:text-red-700 hover:shadow-gray-500 focus:ring-gray-400">
    ...
    <select wire:model="categoryFilter" class="md:w-32 p-2 mr-4 dark:bg-gray-800 dark:text-gray-100 text-blue-500 bg-white border-none rounded-lg shadow-lg cursor-pointer hover:text-red-700 hover:shadow-gray-500 focus:ring-gray-400">
        <option value="">Categorías</option>
        @foreach ($categories as $category)
        <option value="{{ $category->name }}">{{ $category->name }}</option>
        @endforeach
    </select>
    <button wire:click="resetFilters" class="p-2 mr-4 text-blue-500 dark:bg-gray-800 dark:text-gray-100 bg-white border-none rounded-lg shadow-lg hover:text-red-700 hover:shadow-gray-500 focus:ring-gray-400">
        Restablecer
    </button>
</div> --}}
