<div class="my-auto">
    ...
    <x-dialog-modal wire:model="open_create">
        ...
        <x-slot name="content">
            ...
            <div class="relative mt-4">
                <label class="flex flex-col items-center justify-center h-48 gap-4 p-6 mx-auto bg-white border-2 border-gray-300 border-dashed rounded-lg shadow-md cursor-pointer w-72">
                    ...
                    <div class="text-center">
                        <span class="font-normal text-[#173152] text-lg">Agrega una imágen del ramo</span>
                    </div>
                    <input type="file" class="hidden" wire:model.lazy="image" id="{{ $unique_input_identifier }}">
                    <div class="absolute top-0 h-48 w-72 border-dashed rounded-lg bg-gray-400 opacity-50">
                        @if ($image)
            ...
            <x-label value="Compañía" class="text-gray-700" />
            <select class="w-full rounded-md" wire:model.lazy="insuranceCompanyId">
