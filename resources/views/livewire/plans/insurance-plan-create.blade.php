    ...
    <x-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            <form>
                ...
                <div class="relative mt-4">
                    <label class="flex flex-col items-center justify-center h-48 gap-4 p-6 mx-auto bg-white border-2 border-gray-300 border-dashed rounded-lg shadow-md cursor-pointer w-72">
                        <div class="flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#ccc" viewBox="0 0 24 24" class="w-16 h-16 text-gray-600">
                        ...
                        <div class="text-center">
                            <span class="font-normal text-gray-600">Agrega una imagen del plan</span>
                        </div>
                        <input type="file" class="hidden" wire:model="image">
                        <div class="absolute top-0 h-48 w-72">
                            @if ($image)
                            <img class="object-cover w-full h-full rounded-lg" src="{{ $image->temporaryUrl() }}" class="mb-4" alt="Imagen del Plan">
                            @endif
                        </div>
                    </label>
                </div>
                ...
                <select class="w-full rounded-md" wire:model="lineId">
                    <option value="">Selecciona un ramo de seguros</option>
                ...
                <x-input class="w-full" type="text" wire:model="coverage" />
