<div class="relative inline-block text-center cursor-pointer group">
    ...
    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">
            <h2 class="mt-3 text-2xl text-center">Editar Compañía de Seguros</h2>
        </x-slot>
                    ...
                    <div class="relative my-4">
                        <label class="flex flex-col items-center justify-center h-48 gap-4 p-6 mx-auto bg-white border-2 border-gray-300 border-dashed rounded-lg shadow-md cursor-pointer w-72">
                            ...
                            <div class="absolute top-0 h-48 w-72">
                                ...
                                @else
                                <img class="object-cover w-full h-full rounded-lg" src="{{ asset('storage/' . $company->image) }}" class="mb-4" alt="Imagen de Compañía">
                                @endif
                            </div>
                        </label>
                    </div>
